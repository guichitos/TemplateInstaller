...
echo [DEBUG] Escribiendo %REG_VALUE% en "%PPT_MRU_PATH%"
...
echo [DEBUG] Escribiendo %META_VALUE% en "%PPT_MRU_PATH%"
reg add "%PPT_MRU_PATH%" /v "!META_VALUE!" /t REG_SZ /d "!META_DATA!" /f >nul 2>&1
...
(
  ...
  echo REG ADD "%PPT_MRU_PATH%" /v "!META_VALUE!" /t REG_SZ /d "!META_DATA!" /f
